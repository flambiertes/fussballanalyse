...
def load_actual_results() -> pd.DataFrame:
    ...
    if group_path.exists():
        ...
        if "goals_home" in df.columns and "goals_away" in df.columns:
            ...
            frames.append(played[["match_nr", "team_home", "team_away", "goals_home", "goals_away"]])
    ...
    if ko_path.exists():
        ...
        if "goals_home" in ko.columns and "team_home" in ko.columns:
            ...
            played_ko["goals_home"] = played_ko["goals_home"].astype(int)
            played_ko["goals_away"] = played_ko["goals_away"].astype(int)
            frames.append(played_ko[["match_nr", "team_home", "team_away", "goals_home", "goals_away"]])
